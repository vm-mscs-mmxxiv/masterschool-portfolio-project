" {{{
" Name:         Solarized 9
" Description:  Precision colors for machines and people. This is edit of
" original theme.
" Author:       Ethan Schoonover
" Editor:       Vicheslav Modestov
...
" ==========================================================================={{{
" CONFIGURATION OPTIONS - Set these variables BEFORE loading the colorscheme
" ==============================================================================
"
" This colorscheme supports several configuration options that must be set
" before the 'colorscheme solarized8' command. Here are all available options:
"
" CORE OPTIONS:
" -------------
" let g:solarized_use16 = 0           " Use 16-color mode (0=auto, 1=force 16-color)
" let g:solarized_italics = 1         " Enable italic text (0=disable, 1=enable)
" let g:solarized_termtrans = 0       " Transparent background (0=opaque, 1=transparent)
"
" VISIBILITY OPTIONS:
" ------------------
" let g:solarized_visibility = ""     " UI element visibility:
"                                     " ""/"normal" = balanced (default)
"                                     " "high"      = bright, prominent
"                                     " "low"       = subtle, unobtrusive
"
" STYLE OPTIONS:
" -------------
" let g:solarized_old_cursor_style = 0    " Cursor style (0=modern blue, 1=legacy)
" let g:solarized_diffmode = ""           " Diff highlighting:
"                                         " ""/"normal" = standard colors
"                                         " "high"      = high contrast
"                                         " "low"       = low contrast
"
" let g:solarized_statusline = ""         " Status line style:
"                                         " ""/"normal" = default
"                                         " "low"       = low contrast
"                                         " "flat"      = flat style
"
" EXTENDED FEATURES:
" -----------------
" let g:solarized_extra_hi_groups = 0     " Extended syntax highlighting (0=basic, 1=extended)
"                                         " Includes extra highlighting for VimScript, Git, HTML, etc.
"
" EXAMPLE CONFIGURATION:
" ---------------------
" " Place this in your .vimrc or init.vim BEFORE the colorscheme command:
" let g:solarized_termtrans = 1          " Use transparent background
" let g:solarized_visibility = "low"     " Subtle UI elements
" let g:solarized_diffmode = "high"      " High contrast diffs
" let g:solarized_extra_hi_groups = 1    " Enable extended highlighting
"
" set background=dark                    " Choose 'dark' or 'light'
...
" Detect terminal color capability (defaults to 2 colors if not set)
let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 2
" Detect italic support based on terminal capabilities
let s:italics = (((&t_ZH != '' && &t_ZH != '[7m') || has('gui_running')) && !has('iOS')) || has('nvim')

" USER CONFIGURATION OPTIONS - Read user preferences
...
" ==============================================================================
" HIGHLIGHT GROUP LINKS - Basic syntax element mappings
" ==============================================================================
" Link basic syntax elements to their appropriate highlight groups
" This creates consistent highlighting across different file types {{{
...
" TRUE COLOR SUPPORT (GUI/24-bit) - High quality color definitions
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    " Set terminal colors for integrated terminal and other terminal apps
...
" #268bd2 - blue
" #d33682 - deep pink
" #2aa198 - deep marine (strings of text now)
" #eee8d5 - light sand
" #002b36 - almost black blue
" #cb4b16 - brown like light brick
" #586e75 - blueish grey
" #657b83 - more blue then blueish grey
" #839496 - blue lighter then blueish grey
" #6c71c4 - light violet
" #93a1a1 - grey vith a bit of blue (was Normal)
" #b7bdbd - light blueish grey
" #fdf6e3 - very light yellow }}}
    if has('nvim')
     ...
     " BACKGROUND HANDLING - Transparent vs opaque backgrounds
    if s:termtrans
      " BACKGROUND HANDLING - Transparent vs opaque backgrounds
      hi Normal guifg=#b7bdbd guibg=NONE guisp=NONE gui=NONE cterm=NONE
     ...
     " Solid background mode - use colorscheme's background color
      hi Normal guifg=#b7bdbd guibg=#002b36 guisp=NONE gui=NONE cterm=NONE
    ...
    " VISIBILITY SETTINGS - User configurable UI element visibility
    ...
    " Handle transparent backgrounds for line numbers
    if s:termtrans
      hi CursorLineNr guibg=NONE
      hi LineNr guibg=NONE
    endif

    " CURSOR STYLE OPTIONS - User configurable cursor appearance
    ...
    " --------------------------------------------------------------------------
    " CORE UI ELEMENTS - Essential editor interface components
    " --------------------------------------------------------------------------
    ...
    " --------------------------------------------------------------------------
    " SYNTAX HIGHLIGHTING GROUPS - Core language elements
    " --------------------------------------------------------------------------
    hi Comment guifg=#999999 guibg=NONE guisp=NONE gui=italic cterm=italic
    ...
    " MODE-SPECIFIC HIGHLIGHTING - Different editor modes
    hi NormalMode guifg=#96a2a3 guibg=#fdf6e3 guisp=NONE gui=reverse cterm=reverse
    ...
    " ITALIC HANDLING - Conditional italic support
    if !s:italics
      " Remove italic formatting if not supported
    ...
    hi vimCommentString guifg=#999999 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    " Handle italic support for extended groups
    if !s:italics
  ...
  hi! link vimSet Normal
  hi! link vimSetEqual Normal
  hi vimCommentString guifg=#93a1a1 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi vimCommand guifg=#b58900 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi vimCmdSep guifg=#268bd2 guibg=NONE guisp=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi NormalMode ctermfg=254 ctermbg=230 cterm=reverse
    ...
    hi! link vimSet Normal
    hi! link vimSetEqual Normal
    hi vimCommentString ctermfg=247 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi! link vimSet Normal
    hi! link vimSetEqual Normal
    hi vimCommentString ctermfg=242 ctermbg=NONE cterm=NONE
